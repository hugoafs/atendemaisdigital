              ...
              {weeklyLoading ? (
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">{weeklyStats.stats.completedAppointments}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-purple-100">Taxa de presença</span>
                    <span className="font-bold">{weeklyStats.stats.attendanceRate}%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-purple-100">Receita total</span>
                    <span className="font-bold">R$ {weeklyStats.stats.totalRevenue.toFixed(2)}</span>
                  </div>
                </div>
              ) : (
                <div className="space-y-3">
